...
STEM  = 'CAPERS_m3b_photcal'             # Plan A + Calzetti dust ([M/H]=-1 fixed, A_V<0.5, dust1=0)
...
def build_obs():
    ...
    # PHOTCAL DJA v7 primer-uds-north id 11951: cat/spec 0.88 (2.0-2.8 um) -> 0.78 (3.5-4.4 um) (2026-09-15 tilt/anchoring campaign)
    _lam_um = w_obs * 1e-4
    _c = np.where(_lam_um >= 2.76, 1.0 - 0.068 * (_lam_um - 2.76), 1.0)
