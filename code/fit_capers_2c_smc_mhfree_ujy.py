#!/usr/bin/env python3
"""WIDE 2c SMC with the HOT photosphere metallicity free (mh_idx U[0,2]); cold fixed at [M/H]=-1."""
import os, argparse
import m3port as M
...
if __name__ == '__main__':
    ...
    M.fit(STEM, Z, MODEL_KWARGS, build_obs, WEIGHTS, out_dir=OUT, dust_law=DUST_LAW, two_comp=True,
          use_galaxy=USE_GALAXY, pool_n=a.pool, dry_run=a.dry_run, source_label=LABEL + ' (2c SMC, hot [M/H] free)')
