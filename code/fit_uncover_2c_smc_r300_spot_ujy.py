#!/usr/bin/env python3
"""UNCOVER — 2-component (hot+cold) with A_V FREE + logg_cold TIED = logg_hot (same-surface patches / starspots; ndim 16).
...
STEM = 'UNCOVER_2c_smc_r300_spot_ujy'
DUST_LAW = 'smc'
USE_GALAXY = True
TWO_COMP = True
Z = base.Z
...
MODEL_KWARGS = dict(av_cap=8.0, tie_cold='spot')   # A_V FREE (cold T<=3500 default, as UNCOVER_2c)
