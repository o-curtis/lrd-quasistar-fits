...
STEM  = 'UNCOVER_m3b_r300_photcal4'           # Plan A + Calzetti dust ([M/H]=-1 fixed, A_V<0.5, dust1=0)
...
def build_obs():
    ...
    # PHOTCAL4 (2026-09-16): anchor the DJA v4 PRISM spectrum to DJA v7 NIRCam photometry (smooth quadratic, 2% band floor)
    _lam_um = w_obs * 1e-4
    _c = 1.0 + 0.2197 * (np.clip(_lam_um, 2.76, 4.81) - 2.76) - 0.0030 * (np.clip(_lam_um, 2.76, 4.81) - 2.76)**2
