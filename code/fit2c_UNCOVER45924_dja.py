#!/usr/bin/env python3
"""DJA-spectrum M3 phi fit template. SPEC1D ext, wave(um)/flux(uJy)/err."""
import os, argparse
import numpy as np
...
FITS  = os.path.join(CAMP, "dja_UNCOVER45924.fits")
Z     = 4.467
LABEL = "Naidu-UNCOVER45924"
STEM  = "UNCOVER45924_dja_m3_2c"
DUST_LAW = "smc"
...
if __name__ == "__main__":
    ...
    M.fit(STEM, Z, MODEL_KWARGS, build_obs, WEIGHTS, out_dir=CAMP,
          dust_law=DUST_LAW, two_comp=True, pool_n=a.pool, dry_run=a.dry_run, source_label=LABEL)
