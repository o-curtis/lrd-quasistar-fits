#!/usr/bin/env python3
"""R5 mock fit: R5_faint_sub (truth injected on real dja_RUBIES_EGS53254.fits noise)."""
import os, argparse
import numpy as np
import m3port as M
CAMP = "/storage/group/jtw13/default/oCurtisWorkDir/lrdmesa/blueshift-phi-campaign"
MOCK = os.path.join(CAMP, "mock_R5_faint_sub.npz")
Z = 6.621600
STEM = "MOCK_R5_faint_sub_m3"
DUST_LAW = "smc"
...
if __name__ == "__main__":
    ...
    M.fit(STEM, Z, MODEL_KWARGS, build_obs, WEIGHTS, out_dir=CAMP,
          dust_law=DUST_LAW, pool_n=a.pool, dry_run=a.dry_run, source_label="R5_faint_sub")
