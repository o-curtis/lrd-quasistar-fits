...
STEM  = 'CAPERS_m3b_photcal2'             # Plan A + Calzetti dust ([M/H]=-1 fixed, A_V<0.5, dust1=0)
...
def build_obs():
    ...
    # PHOTCAL2 (2026-09-16): anchor the DJA v4 PRISM spectrum to the DJA v7 PRIMER-UDS NIRCam photometry
    # (primer-uds-north-grizli-v7.2-fix_phot_apcorr id 11951, 0.06 arcsec): catalog/spectrum ratios normalised to
    # F277W = 1 are 0.871 (F356W), 0.883 (F410M), 0.886 (F444W); interpolated in wavelength, held constant beyond
    # F444W and left at 1 below 2.76 um (F200W agrees with F277W; bluer bands are host-dominated).
    _lam_um = w_obs * 1e-4
    _c = np.interp(_lam_um, [2.76, 3.55, 4.08, 4.38], [1.0, 0.871, 0.883, 0.886])
