#!/usr/bin/env python3
"""WIDE — 2-component (hot+cold) with A_V FREE + logg_cold TIED = logg_hot (same-surface patches / starspots; ndim 16).
...
MODEL_KWARGS = dict(av_cap=8.0, cold_hi=3000.0, tie_cold='spot')   # A_V FREE, cold T<=3000, spot tie
