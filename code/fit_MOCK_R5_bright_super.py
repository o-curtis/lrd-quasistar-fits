#!/usr/bin/env python3
"""R5 mock fit: R5_bright_super (truth injected on real dja_RUBIES_UDS31747.fits noise)."""
import os, argparse
import numpy as np
import m3port as M
CAMP = "/storage/group/jtw13/default/oCurtisWorkDir/lrdmesa/blueshift-phi-campaign"
MOCK = os.path.join(CAMP, "mock_R5_bright_super.npz")
Z = 4.129100
STEM = "MOCK_R5_bright_super_m3"
DUST_LAW = "smc"
...
if __name__ == "__main__":
    ...
    M.fit(STEM, Z, MODEL_KWARGS, build_obs, WEIGHTS, out_dir=CAMP,
          dust_law=DUST_LAW, pool_n=a.pool, dry_run=a.dry_run, source_label="R5_bright_super")
