...
FITS=os.path.join(CAMP,"dja_GN15498.fits"); Z=6.994; LABEL="FRESCO-GN15498"; STEM="GN15498_fr_m3_2c"
DUST_LAW="smc"; MODEL_KWARGS=dict(av_cap=8.0)
...
if __name__=="__main__":
    ...
    M.fit(STEM,Z,MODEL_KWARGS,build_obs,[],out_dir=CAMP,dust_law=DUST_LAW,two_comp=True,pool_n=a.pool,dry_run=a.dry_run,source_label=LABEL)
