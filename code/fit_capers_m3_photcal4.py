...
STEM  = 'CAPERS_m3b_photcal4'             # Plan A + Calzetti dust ([M/H]=-1 fixed, A_V<0.5, dust1=0)
...
def build_obs():
    ...
    _lam_um = w_obs * 1e-4
    _c = 1.0 - 0.3346 * (np.clip(_lam_um, 2.76, 4.3787) - 2.76) + 0.1617 * (np.clip(_lam_um, 2.76, 4.3787) - 2.76)**2
