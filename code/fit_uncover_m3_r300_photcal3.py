...
STEM  = 'UNCOVER_m3b_r300_photcal3'           # Plan A + Calzetti dust ([M/H]=-1 fixed, A_V<0.5, dust1=0)
...
def build_obs():
    ...
    _lam_um = w_obs * 1e-4
    _c = np.interp(_lam_um, [2.76, 2.9929, 3.3586, 3.6195, 4.0787, 4.2802, 4.6285, 4.8145], [1.0, 1.0903, 1.2057, 1.2333, 1.2395, 1.2727, 1.4647, 1.5251])
