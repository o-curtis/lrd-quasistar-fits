#!/usr/bin/env python3
"""Masked clone: identical config to fit_rs_m3c_smc, with rest 3400-4100 A removed
from the likelihood on every arm. Original untouched."""
import argparse
import m3port as M
import fit_rs_m3c_smc as drv
import fit_rs_m3 as base

STEM = 'BMKP_RS_m3c_smc'
...
if __name__ == '__main__':
    ...
    M.fit(STEM, base.Z, drv.MODEL_KWARGS, build_obs, base.WEIGHTS,
          out_dir=drv.OUT, dust_law=drv.DUST_LAW, pool_n=a.pool,
