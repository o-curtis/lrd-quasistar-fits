...
FITS  = os.path.join(CAMP, "jw04233-o002_s000182791_nirspec_clear-prism_x1d.fits")
Z     = 4.713
LABEL = "RUBIES-UDS182791"
STEM  = "UDS182791_m3"
DUST_LAW = "smc"
...
if __name__ == "__main__":
    ...
    M.fit(STEM, Z, MODEL_KWARGS, build_obs, WEIGHTS,
          out_dir=CAMP, dust_law=DUST_LAW, pool_n=a.pool, dry_run=a.dry_run,
          source_label=LABEL)
