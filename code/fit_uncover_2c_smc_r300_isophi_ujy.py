#!/usr/bin/env python3
"""UNCOVER — 2-component (hot+cold) with A_V FREE + logg_cold TIED = logg_hot + 4log10(Tc/Th) (phi_cold==phi_hot, spherical-wind geometry; ndim 16).
...
STEM = 'UNCOVER_2c_smc_r300_isophi_ujy'
DUST_LAW = 'smc'
USE_GALAXY = True
TWO_COMP = True
Z = base.Z
...
MODEL_KWARGS = dict(av_cap=8.0, tie_cold='isophi')   # A_V FREE (cold T<=3500 default, as UNCOVER_2c)
