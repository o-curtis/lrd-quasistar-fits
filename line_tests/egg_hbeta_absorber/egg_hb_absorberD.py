...
CASES = {
    ...
    'D blue PINNED + red free ': (head + [(-260, -100), (40, 160), (-2*aB, 0)]
...
a, c = out['A published (blue pinned)'], out['D blue PINNED + red free ']
b = a
print('N points = %d, lnN = %.3f' % (N, lnN))

print('D - A : dchi2 = %+8.1f (3 extra)  dBIC = %+8.1f' % (c['chi2']-a['chi2'], c['bic']-a['bic']))
json.dump(out, open('/home/omc5226/work/lrdmesa/gobig_work/egg_hb_absorberD.json', 'w'), indent=1)
print('\nwrote egg_hb_absorberD.json')
